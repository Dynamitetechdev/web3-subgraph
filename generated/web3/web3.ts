...
export class nftId extends ethereum.Event {
  get params(): nftId__Params {
    return new nftId__Params(this);
  }
}

export class nftId__Params {
  _event: nftId;

  constructor(event: nftId) {
    this._event = event;
  }
...
export class web3 extends ethereum.SmartContract {
  static bind(address: Address): web3 {
    return new web3("web3", address);
  }
